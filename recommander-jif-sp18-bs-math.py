...
# Import data
df_train = pd.read_csv('sp18-for-weka-2020-01-19-jif-bsmath-clean.csv')
...
data_train = data.iloc[:110]
data_test = data.iloc[110:]
X = data_train.values
...
dot_data = tree.export_graphviz(clf, out_file=None, 
                     class_names=['BS Mathematics','BS CS'],  
                     filled=True, rounded=True,  
                     special_characters=True)  
graph = graphviz.Source(dot_data)  
graph.render("dtree_jif_bs_math") 
